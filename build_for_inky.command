...
dotnet publish -c Release -r win-x86 --self-contained /p:PublishTrimmed=true /p:PublishSingleFile=true -o BuildForInky inklecate/inklecate.csproj
...
dotnet publish -c Release -r linux-x64 --self-contained /p:PublishTrimmed=true /p:PublishSingleFile=true -o BuildForInky inklecate/inklecate.csproj
