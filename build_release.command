...
dotnet publish -c Release -r osx-x64 --self-contained /p:PublishTrimmed=true /p:PublishSingleFile=true -o ReleaseBinary/inklecate/osx64 inklecate/inklecate.csproj
